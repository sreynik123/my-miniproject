export default  function Register() {
     ...
     return (
         <main className="bg-white flex overflow-hidden">
             <div className="flex-1 hidden lg:block">
                 <img src="https://www.washingtonpost.com/graphics/2019/entertainment/oscar-nominees-movie-poster-design/img/black-panther-web.jpg" className="w-full h-screen object-cover" />
             </div>
